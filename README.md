About jupyter-wxyz-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter-wxyz-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11524&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-wxyz-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `wxyz_core, wxyz_datagrid, wxyz_dvcs, wxyz_html, wxyz_json_e, wxyz_json_schema_form, wxyz_jsonld, wxyz_lab, wxyz_svg, wxyz_tpl_jinja, wxyz_yaml` can be installed with `conda`:
...
```
mamba install wxyz_core wxyz_datagrid wxyz_dvcs wxyz_html wxyz_json_e wxyz_json_schema_form wxyz_jsonld wxyz_lab wxyz_svg wxyz_tpl_jinja wxyz_yaml
```

It is possible to list all of the versions of `wxyz_core` available on your platform with `conda`:
...
```
mamba search wxyz_core --channel conda-forge
```
...
mamba repoquery search wxyz_core --channel conda-forge

# List packages depending on `wxyz_core`:
mamba repoquery whoneeds wxyz_core --channel conda-forge

# List dependencies of `wxyz_core`:
mamba repoquery depends wxyz_core --channel conda-forge
```
